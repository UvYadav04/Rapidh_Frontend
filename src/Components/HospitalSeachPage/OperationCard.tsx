...
function OperationCard({ operation, item, setoperation }: { operation: OperationInterface, item: OperationList, setoperation: Dispatch<SetStateAction<OperationInterface>> }) {
    return (
        <div className="operationCard relative h-fit" >

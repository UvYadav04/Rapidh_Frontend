...
function Authentication() {
    ...
    const handleLogin = () => {
        if (logindata.email == "")
            return enablerror(0)
        const val = validator.validate(logindata.email)
        if (!val)
            return enablerror(0)
    ...
    const handleSignup = () => {
        ...
        if (signupdata.email == "")
            return enablerror(0)
        const val = validator.validate(signupdata.email)
        if (!val)
            return enablerror(0)
        ...
        if (! /[a-z]/.test(signupdata.password) || !/[1-9]/.test(signupdata.password))
            return enablerror(4)
    ...
    useMemo(() => {
        if (!loading) {
            if (profile && Object.keys(profile).length > 0) {
                ...
                if (erroruser?.message === "This Email has been used before")
                    enablerror(7)
                else if (erroruser?.message === "Invalid password or email")
                    enablerror(6)
                else if (erroruser?.message === "This email is not registered.")
                    enablerror(10)
                else
                    enablerror(12)
                dispatch(resetError())
                    ...
                    index === 12 ? (
                        ...
                        <div className="login w-1/2 h-2/3 bg-slate-200 flex flex-col justify-start gap-10 border-2 border-slate-400 px-5 pt-10 pb-5 relative">
                            ...
                            <div className="inputpassword relative">
                                ...
                                <input type="password" name='password' placeholder='Enter Password' className='w-full text-lg p-0 text-slate-400 focus:outline-none rounded-sm px-2 py-1' value={logindata.password} onChange=
                        ...
                        <div className="signup w-1/2 h-2/3 bg-slate-200 flex flex-col justify-start relative gap-5 border-2 border-slate-400 px-5 pt-10 pb-5">
                            ...
                            <div className="inputname relative">
                                ...
                                <input type="text" name='name' placeholder='Enter Full Name' className='w-full text-lg p-0 text-slate-400 focus:outline-none rounded-sm px-2 py-1' value={signupdata.name} onChange={(e) => handleInputChange(e, setsignupdata)} />
                            ...
                            <div className="inputemail relative">
                                ...
                                <input type="text" name='email' placeholder='Enter Email' className='w-full text-lg p-0 text-slate-400 focus:outline-none rounded-sm px-2 py-1' value={signupdata.email} onChange={(e) => handleInputChange(e, setsignupdata)} />
                            ...
                            <div className="inputpassword relative">
                                ...
                                <input type="password" name='password' placeholder='Enter Password' className='w-full text-lg p-0 text-slate-400 focus:outline-none rounded-sm px-2 py-1' value={signupdata.password} onChange={(e) => handleInputChange(e, setsignupdata)} />
                            ...
                            <div className="inputconfirmPassword relative">

                                <input type="password" name='confirmPassword' placeholder='Confirm Password' className='w-full text-lg p-0 text-slate-400 focus:outline-none rounded-sm px-2 py-1' value={signupdata.confirmPassword} onChange={(e) => handleInputChange(e, setsignupdata)} />
